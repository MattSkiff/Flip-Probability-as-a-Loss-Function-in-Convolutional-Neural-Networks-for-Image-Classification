...
At it's simplest a \gls{nn} for binary classification is a single \gls{neuron} comprising of a weighted sum of the input features, the addition of a bias term and the application of an \gls{activationfunction} to provide an output for a given input instance $i$. This is summarised in \ref{fig:nn_simple}. 
...
% find early implementations or delete line
...
Tensorflow, developed by Google,  \cite{tale_dl_databricks}. All three frameworks have the advantage of being completely open source. \bigskip
...
% ZAMBINGO - reference for AI safety would be good here
