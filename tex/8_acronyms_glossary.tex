...
\newglossaryentry{vanishinggradients}
{
    name=vanishing gradients,
    description={
    The tendency of gradients that are being back-propagated to 'vanish' i.e. diminish in size to the point where numerical underflow issues occur. This is closely linked to the 'exploding gradients' problem
    }
}
...
{
    name={VC},
    description={The Vapnik-Chernonekis  dimension, this is a measure of the complexity, or capacity of a classifier. It denotes the largest number of instances, relative to the ambient dimension, that are always able to classified by a class of classifiers \cite[Chapter~2]{haykin}},
    first={Vapnik-Chernonekis (VC)},
    long={Vapnik-Chernonekis}
}
...
\newacronym{gsn}{GSN}{Generative Stochastic Network}
\newacronym{gtn}{GTN}{Graph Transformer Network}
\newacronym{ide}{IDE}{Integrated Development Environment}
\newacronym{ilsvrc}{ILSVRC}{ImageNet Large Scale Visual Recognition Challenge}
\newacronym{jll}{JLL}{Johnson-Lindenstraus Lemma} 
...
\newacronym{r-cnn}{RCNN}{Region-Convolutional Neural Network}
...
\newacronym{uap}{UAP}{Universal Approximation}
\newacronym{vae}{VAE}{Variational Auto-Encoder}
%\newacronym{vc}{VC}{Vapnik-Chernonekis}
